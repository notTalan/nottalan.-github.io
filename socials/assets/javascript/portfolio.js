...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://twitter.com/${link.link}" target="_BLANK">${link.name}</a>`);

    link = $('#marquee').children('a').last();

    if (i != links.length - 1) $('#marquee').append(' <img class="emoticon" src="assets/others/icon.png"> ');
  }
...
const writeLine = (text, speed, timeout, callback) => {
  ...
  $('#main').fadeOut(100, () => {
    ...
    setTimeout(() => {
      const typed = new Typed('#brand2', {
        strings: app.brandDescription2,
        typeSpeed: 120,
    ...
    setTimeout(() => {
      const typed = new Typed('#brand3', {
        strings: app.brandDescription3,
        typeSpeed: 120,
    ...
    setTimeout(() => {
      const typed = new Typed('#brand4', {
        strings: app.brandDescription4,
        typeSpeed: 120,
    ...
    setTimeout(() => {
      const typed = new Typed('#brand5', {
        strings: app.brandDescription5,
        typeSpeed: 120,
    ...
    setTimeout(() => {
      const typed = new Typed('#brand6', {
        strings: app.brandDescription6,
        typeSpeed: 120,
